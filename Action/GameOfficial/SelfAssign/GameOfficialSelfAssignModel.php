 ...
 */
class GameOfficialSelfAssignModel extends ActionModelFactory
{
    public $user;
    public $project;
    public $projectKey;
    ...
    {   
        ...
        $this->userPerson = $userPerson = $request->attributes->get('project');
        
        // Need game
        $num  = $request->attributes->get('game');
        $game = $this->gameRepo->findOneByProjectNum($project->getKey(),$num);
        if (!$game) {
      ...
      //}
        ...
        $this->userPerson = $request->attributes->get('userPerson');
